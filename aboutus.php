    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">JustEat</a>
        </div>
...
?>
    ...
    <div class="wide">
        <h2 style="color: red">About the food culture in JustEat</h2>
        <br>
        ...
        <table>
  <tr>
    <!-- Column 1: About JustEat -->
    <td>
      <th><h4>ABOUT JUSTEAT</h4></th>
      <tr><td>Who Are We</td></tr>
      <tr><td>Blog</td></tr>
    ...
    <td>
      <th><h4>SOCIAL LINKS</h4></th>
      <tr>
        <td><img src="images/insta.jpg" alt="" style="width:30px"></td>
        <td><img src="images/facebook.jpg" alt="" style="width:30px"></td>
        <td><img src="images/googleplus.png" alt="" style="width:30px"></td>
      </tr>
    </td>
  </tr>
</table>
